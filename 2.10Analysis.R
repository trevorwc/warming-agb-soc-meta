...
ncomp_results = data.frame(
  "yi" = c(meta.agb.last.lowN$TE.random, meta.agb.last.highN$TE.random, meta.SOC.last.lowN$TE.random, meta.SOC.last.highN$TE.random, meta.eco.last.lowN$TE.random, meta.eco.full.highN$TE.random),
  "yi.lower" = c(meta.agb.last.lowN$lower.random, meta.agb.last.highN$lower.random, meta.SOC.last.lowN$lower.random, meta.SOC.last.highN$lower.random, meta.eco.last.lowN$lower.random, meta.eco.full.highN$lower.random),
  "yi.upper" = c(meta.agb.last.lowN$upper.random, meta.agb.last.highN$upper.random, meta.SOC.last.lowN$upper.random, meta.SOC.last.highN$upper.random, meta.eco.last.lowN$upper.random, meta.eco.full.highN$upper.random),
